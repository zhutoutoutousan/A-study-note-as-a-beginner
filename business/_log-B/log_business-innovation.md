...
- [Current innovation pipeline](#current-innovation-pipeline)
  - [Phase 0: Prerequisites](#phase-0-prerequisites)
    - [How to define innovation pipeline?](#how-to-define-innovation-pipeline)
    - [How do you obtain, validate, manage, and  innovation ideas?](#how-do-you-obtain-validate-manage-and--innovation-ideas)
  - [Phase 1: ???](#phase-1-)
  - [Phase 2: ???](#phase-2-)
  - [Phase 3: ???](#phase-3-)
  - [Phase $x$: ???](#phase-x-)
- [Temporary innovation ideas store](#temporary-innovation-ideas-store)
  - [Second brain design](#second-brain-design)
  - [](#)
- [Innovation logistics & Methodology](#innovation-logistics--methodology)
  - [Channel](#channel)
  - [Innovation Ontology](#innovation-ontology)
  - [Sustainable innovation development](#sustainable-innovation-development)
    - [How to train your innovation ability?](#how-to-train-your-innovation-ability)
  - [Erudition](#erudition)
...
### How to define innovation pipeline?
### How do you obtain, validate, manage, and  innovation ideas?
## Phase 1: ???
- All ideas in your #ideasandinnovations section
## Phase 2: ???
## Phase 3: ???
## Phase $x$: ???

# Temporary innovation ideas store
- If you can't put your idea anywhere else for the sake of categorization, put it here
## Second brain design
- Hive mind & Individual design
  - 本体:
    - 概念: 一个人类的知识, MVP(Minimal Valuable Process: 最小有价值过程之最佳实践)的实时协作平台
    - Context & Restraints
      - *远交近攻*的人类竞争逻辑下的知识分享independence的考虑
        - Value Source
          - 匿名性
            - 个人的知识库对自己全公开
            - 个人可以选择将自己部分的知识库进行标签, 并放入人类知识图谱池的指定树的树叶上, 数据一旦上传, 上传人对其他人匿名, 并且由**专业的风险咨询及IT咨询公司**进行审核, 保证该知识对人类共同体有利, 且竞争者无法通过社会工程等各种攻击方式获取商业机密
          - 功能强大
            - 使用场景全覆盖
              - 手机端
                - Android
            ...
            - 自下而上的方法
    - 痛点: 工具性 & 全球性 & 知识的独立性
  - 2021/12/2: Ideation ends now, back to daily work to put food on the table, send to someone who might be interested 

## 

# Innovation logistics & Methodology
