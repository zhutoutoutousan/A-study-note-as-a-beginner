  ...
  - TOPIC International Team Collaboration
    ...
    - Techno part
      ...
      - [Video Editor](https://www.youtube.com/watch?v=a_ihuf5vp5A)
        ...
        - SUPPLEMENT [Electron 5 apps](https://www.youtube.com/watch?v=3hqawL0xVxo)
          - VSM: 3:00
      ...
      - [Vue source code - 2](https://www.youtube.com/watch?v=bDGeRbnCB54&list=PLjGV94tuTnDNU7eNelPwBMrtte-TSVcWL&index=2)
        - VSM: 7:02
        - LM: 2
      - [Taro - 8](https://www.youtube.com/watch?v=HWd1dcVQYzQ&list=PLwDQt7s1o9J7Z52XqERZ5SK5Cd5y9Iz01&index=7)
        - VSM: 14:00
        - LM: 8
      - [Taro Practice - 4](https://www.youtube.com/watch?v=zH3W2lYnpfo&list=PLxrK5TbqPkt-VCWIcbcokNvZxgNNj3ydn&index=4)
        - VSM: 13:30
        - [typeof and instanceof](https://www.youtube.com/watch?v=Ef6hYqxf8pk)
          - VSM: 1:30
    ...
    - Money --> Groundwork & 30,000 feet outlook
      ...
      - Groundwork
        ...
        - Basics --> WAIVE `ROOT.CentralExecutiveFunction.requestAdditionTimeAllocation(5)`
          ...
          - MUTATION [Data Visualization with D3, JavaScript, React](https://www.youtube.com/watch?v=2LhoCfjm8R4)
            - VSM: 15:00
...
- Italian+ - Lower B2++
  ...
  - TOPIC: Advanced Web Design(CSS, Figma), Drawing, Branding, Branding Design, 3D product design, hospitality, cuisine
    - [react-syncfusion-admin](https://www.youtube.com/watch?v=jx5hdo50a2M)
      - VSM: 10:00
      - SUPPLEMENT Supplement
    ...
    - Skills
      - Commerce
        - Basics
          - [Dropshipping course](https://www.youtube.com/watch?v=-xV4yAlfINU)
            - VSM: 34:30
            - VOCABULARY 과정 | 100% TTL, 무료 | 100% TTL, 시작 | 100% TTL, 것 | 30%, 현학 | 100% TTL, 환경 | 100% TTL
      ...
      - GenZ Graphics Design
        - [AI Course](https://www.youtube.com/watch?v=3RTqLQ1MaQU)
          - VSM: 33:00
          - VOCABULARY -으로, 원하다 | 100% TTL, 가다 | 100% TTL, 제안하다 | 100% TTL
  ...
  - TOPIC | Electrical Engineering, Chemical Engineering, Chemistry basics
    - \* - JP
      ...
      - [Assembly Language Programming with ARM](https://www.youtube.com/watch?v=gfmRrPjnEw4)
        ...
        - VOCABULARY 終了 | 30%, 相互作用 | 90%, 結果 | 90%, 続ける | 50%, 基本的 | 100% TTL
        - VOCABULARY アプリケーション | 30%, 外部 | 30%, 出発点 | 100% TTL, 設定する | 100% TTL, 始まる | 60%
        - TOOL [CPUlator](https://cpulator.01xz.net/)
        - SUPPLEMENT [What happens when you type google.com into your browser and press enter? (Detailed Analysis)](https://www.youtube.com/watch?v=dh406O2v_1c)
          - VSM: 15:00
    - JP - \*
      ...
      - Astrophysics
        - ASTR 160
          - [1. Introduction](https://www.youtube.com/watch?v=nzmFc2gjUo4&list=PLD79A28ED01799FE7)
            - VSM: 5:00
            - VOCABULARY μαλώνω, αντιμετωπίζω, σχόλιο
  ...
  - TOPIC Rigorous science
    - Linear Algebra
      - [Linear algebra full course](https://www.youtube.com/watch?v=M2FL6nGmptw)
        - Videomark: 2:04:00
        - VOCABULARY εσύ | 40%, πλευρά | 32%, μπορώ | 42%
        - CONFIG: *Can only progress whence multi-side-channel stimulation is activated*
        - Bookpair
